...
export function ReportsModule() {
  ...
  return (
    <div className="p-4 sm:p-8 bg-gradient-to-br from-slate-50 to-slate-100 min-h-screen font-sans">
        {/* Header */}
        ...
        <div>
          ...
          <p className="text-slate-500 mt-2 font-medium">Dashboard analítico y generación de reportes</p>
        </div>
        <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto mt-4 md:mt-0">
          <motion.button 
            onClick={() => setIsScheduleOpen(true)}
            className="px-5 py-2.5 border-2 border-slate-300 text-slate-800 rounded-xl font-semibold hover:bg-slate-100 transition-colors w-full sm:w-auto cursor-pointer"
      ...
      <div id="pdfArea" className="space-y-6 bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
        ...
        {/* Filtros de Fecha */}
        <div className="flex flex-col sm:flex-row gap-4 items-stretch sm:items-end bg-gray-50 p-4 rounded-xl border border-gray-200">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto mt-4 sm:mt-0">
              ...
              <motion.button
                ...
                className="flex items-center justify-center gap-2 px-4 py-2 border-2 border-emerald-500 text-emerald-800 rounded-xl text-sm font-semibold hover:bg-emerald-50 transition-colors w-full sm:w-auto cursor-pointer"
                whileHover={{ scale: 1.03 }}
                whileTap={{ scale: 0.95 }}
              >
            ...
            >
              ...
              <div className="flex gap-3 mt-8">
                <motion.button 
                  ...
                  className="flex-1 border-2 border-slate-300 text-slate-800 rounded-xl py-2.5 font-semibold hover:bg-slate-100 transition-colors cursor-pointer"
